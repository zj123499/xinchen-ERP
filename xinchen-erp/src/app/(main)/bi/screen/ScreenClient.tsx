...
// ============================================================
// P9 动态数据大屏（深度动态版）— 独立 chunk，按需加载
// 从 page.tsx 通过 next/dynamic 懒加载，echarts ~1MB 不计入首屏
// ============================================================
  ...
  return (
    <div className="pw">
      ...
      <style jsx>{`
        ...
        .pw::before, .pw::after { content: ""; position: absolute; left: 0; right: 0; height: 40px; z-index: 2; pointer-events: none; }
        ...
        .pw-card { background: linear-gradient(135deg, rgba(20,33,56,.9), rgba(12,20,38,.7)); border: 1px solid rgba(34,211,238,.18); border-radius: 10px; padding: 10px 12px; }
          ...
          {progressNodes.map((n, i) => (
            <div className="bs-fn" key={i}>
              <div className="bs-fn-top">
                <span className="bs-fn-num" style={{ color: PALETTE[i % PALETTE.length] }}><AnimatedNumber value={nodeCounts[i]} /></span>
