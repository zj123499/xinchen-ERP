                  ...
                  {data.list.map((lead) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        ...
                        {lead.wechat && (
                          <div className="text-xs text-slate-400 mt-0.5">微信: {lead.wechat}</div>
                        )}
                      </td>
                      <td className="px-4 py-3">
                      ...
                      <td className="px-4 py-3">
                        <div className="text-sm text-slate-700">
                          ...
                          {lead.targetDegree && (
                            <span className="text-xs text-slate-400">{lead.targetDegree}</span>
                          )}
                        </div>
                      </td>
                      <td className="px-4 py-3">
                        <span className={`inline-flex text-xs font-medium px-2 py-0.5 rounded-full ${STATUS_MAP[lead.status]?.color || "bg-gray-100 text-slate-800"}`}>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">学生状态</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">咨询业务</label>
                  <select
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {formData.source === "PARTNER" && (
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1">选择合作方</label>
                    <select
                ...
                {(formData.source === "SITE" || formData.source === "SEARCH") && (
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1">选择站点</label>
                    <select
                ...
                {["MEDIA_XHS", "MEDIA_SPH", "MEDIA_DY"].includes(formData.source) && (
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1">选择来源账号</label>
                    <select
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">分配顾问</label>
                  <select
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4">
            ...
            <div className="p-6">
              ...
              <p className="text-xs text-slate-400 mt-2">删除后不可恢复，相关跟进记录也将一并删除。</p>
              {formError && (
      ...
      {conflictData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4">
            ...
            <div className="p-6">
              <p className="text-sm text-slate-700 mb-4">{conflictData.message}</p>
              {conflictData.existingLead && (
                <div className="bg-slate-50 rounded-lg p-4 mb-4">
                  <div className="text-sm font-medium text-slate-900">{conflictData.existingLead.name}</div>
